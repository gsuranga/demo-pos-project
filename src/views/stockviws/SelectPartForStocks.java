 ...
 * @author SHDINESH
 */
public class SelectPartForStocks extends javax.swing.JDialog {
     ...
     */
    public SelectPartForStocks(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public SelectPartForStocks(java.awt.Frame parent, boolean modal, DefaultTableModel dtm) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tblSelectItem.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "part id", "Brand", "Part No", "Description", "Selling Price", "Buying Price", "Category", "Model", "Supplier", "Re Order Qty", "Remaining Qty", "All"
            }
        ) {
...
//change VK_down
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectPartForStocks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                SelectPartForStocks dialog = new SelectPartForStocks(new javax.swing.JFrame(), true);
